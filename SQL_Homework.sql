...
SELECT film.title, COUNT(r.rental_id) AS "rented count"
FROM film
JOIN inventory i
...
GROUP BY film.title
ORDER BY COUNT("rented count") desc;
...
-- (Hint:use the following tables: category, film_category, inventory, payment, and rental.)
...
-- by gross revenue. Use the solution from the problem above to create 
-- a view. If you haven't solved 7h, you can substitute another query 
-- to create a view.
